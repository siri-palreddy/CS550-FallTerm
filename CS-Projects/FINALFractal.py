...
WIDTH = 420 # width and height of our picture in pixels
HEIGHT = 420
...
for curFractal in range(totalFractals):
     ...
     for row in range(HEIGHT):
         for col in range(WIDTH):
             ...
             rd = hex(mandelVal % randR * 32)[2:].zfill(2)#Randomizing color
...
k = 0
for img in Imgs:
     canvas.create_image(420*k,0, image = img, state = "normal", anchor 
= tkinter.NW)
     k+= 1
